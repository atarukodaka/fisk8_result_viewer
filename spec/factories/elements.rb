  ...
  factory :element do
    trait :solo_jump do
      ...
      after(:create) do |element|
        ...
        detail = create(:element_judge_detail, element: element)
        official = element.score.performed_segment.officials.find_by(number: detail.number)
        detail.update(official: official)
      end
    end
