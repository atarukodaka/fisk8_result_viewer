...
RSpec.describe Competition do
  describe 'normalization' do
    describe 'unknown' do
      subject { Competition.create(short_name: 'FOOOOTESTDUMMY', start_date: Time.zone.today)}
    ...
    describe 'normalize name, class, type' do
      subject {
        ...
        Competition.create(short_name: 'ZZZWC2017', start_date: '2017-7-1')
      }
    ...
    describe 'no short_name' do
      subject { Competition.create(name: 'Foo Skating') }
      its(:short_name) { is_expected.to eq('FOO_SKATING') }
    end
  end
end
