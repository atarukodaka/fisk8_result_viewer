    ...
    @_filters ||= [
      {
        ...
        field: { key: :competition_name,  input_type: :text_field, },
      },
      {
        label: [hname(:competition_class), hname(:competition_type)].join(' / '),
        fields: [ { key: :competition_class, input_type: :select, label: hname(:competition_class)},
      ...
      },
      {
        ...
        field: { key: :site_url, input_type: :text_field },
      },
