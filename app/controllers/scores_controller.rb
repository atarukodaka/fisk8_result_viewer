class ScoresController < ApplicationController
  ...
  def score_summary(score)
    Listtable.new(view_context).records(score).columns([:skater_name, :competition_name, :category, :segment, :segment_starting_time, :tss, :tes, :pcs, :deductions, :result_pdf, :scorecalc, :youtube_search])
